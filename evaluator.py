...
positional arguments:
  goldFile              Path of the Knowledge Graph file with the gold data
  predictionFile        Path of the Knowledge Graph file with the predicted data
...
#######################################################
# these functions are used to represent a KNowledgeGraph document
...
#######################################################
# these functions are used to read a KnowledgeGraph dataset

# Loads KnowledgeGraph documents
def readKnowledgeGraphFile(dataset, foldToRead, propertiesToConsider={}):
  documents = {}
  properties = {}
  passagesWithError = set()
  
  reader = io.open(dataset, "r", encoding='utf8')
  for line in reader:
...
def main():
  ...
  parser.add_argument("goldFile", type=str,
            help="Path of the KnowledgeGraph file with the gold data")
  parser.add_argument("predictionFile", type=str,
            help="Path of the KnowledgeGraph file with the predicted data")
  ...
  # Read files
  gold, goldProperties = readKnowledgeGraphFile(args.goldFile, args.f)
  prediction, predictedProperties = readKnowledgeGraphFile(args.predictionFile, args.f, goldProperties)
